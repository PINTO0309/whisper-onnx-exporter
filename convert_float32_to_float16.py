...
input_onnx_files = [
    ...
    # "large-v1/large-v1_encoder_11_pre",
    # "large-v1/large-v1_encoder_11_post",
    # "large-v2/large-v2_decoder_11",
    # "large-v2/large-v2_encoder_11",
    "large-v2/large-v2_encoder_11_pre",
    "large-v2/large-v2_encoder_11_post",
]
...
for input_onnx_file in input_onnx_files:
    ...
    model_float16 = \
        convert_float_to_float16_model_path(
            model_path=f'onnx-models_/{input_onnx_file}.onnx',
            keep_io_types=True,
        )
